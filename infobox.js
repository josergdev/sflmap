...
(InfoBox.prototype = new google.maps.OverlayView()),
  ...
  (InfoBox.prototype.getCloseBoxImg_ = function() {
    ...
    return (
      "" !== this.closeBoxURL_ &&
        (img =
          '<md-button class="md-icon-button infoBox-close" aria-label="More"><img src="http://www.esflspain.org/wp-content/uploads/2018/02/close.svg"/></md-button>'),
      img
    );
  }),
  ...
  (InfoBox.prototype.panBox_ = function(disablePan) {
    ...
    if (!disablePan && (map = this.getMap()) instanceof google.maps.Map) {
      map.getBounds().contains(this.position_) || map.setCenter(this.position_),
        map.getBounds();
  ...
  (InfoBox.prototype.setOptions = function(opt_opts) {
    void 0 !== opt_opts.boxClass &&
      ((this.boxClass_ = opt_opts.boxClass), this.setBoxStyle_()),
      void 0 !== opt_opts.boxStyle &&
        ((this.boxStyle_ = opt_opts.boxStyle), this.setBoxStyle_()),
      void 0 !== opt_opts.content && this.setContent(opt_opts.content),
      void 0 !== opt_opts.disableAutoPan &&
        (this.disableAutoPan_ = opt_opts.disableAutoPan),
      void 0 !== opt_opts.maxWidth && (this.maxWidth_ = opt_opts.maxWidth),
      void 0 !== opt_opts.pixelOffset &&
        (this.pixelOffset_ = opt_opts.pixelOffset),
      void 0 !== opt_opts.alignBottom &&
        (this.alignBottom_ = opt_opts.alignBottom),
      void 0 !== opt_opts.position && this.setPosition(opt_opts.position),
      void 0 !== opt_opts.zIndex && this.setZIndex(opt_opts.zIndex),
      void 0 !== opt_opts.closeBoxMargin &&
        (this.closeBoxMargin_ = opt_opts.closeBoxMargin),
      void 0 !== opt_opts.closeBoxURL &&
        (this.closeBoxURL_ = opt_opts.closeBoxURL),
      void 0 !== opt_opts.infoBoxClearance &&
      ...
      void 0 !== opt_opts.enableEventPropagation &&
